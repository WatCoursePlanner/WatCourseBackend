...
class CreateStudentProfileRequest(
...
) : Message<CreateStudentProfileRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is CreateStudentProfileRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "CreateStudentProfileRequest{", separator = ", ", postfix =
        "}")
  }
  ...
  ): CreateStudentProfileRequest = CreateStudentProfileRequest(degrees, startingYear, coopStream,
      schedule, unknownFields)

  companion object {
    @JvmField
    val ADAPTER: ProtoAdapter<CreateStudentProfileRequest> = object :
        ProtoAdapter<CreateStudentProfileRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      CreateStudentProfileRequest::class, 
      "type.googleapis.com/com.watcourses.wat_courses.proto.CreateStudentProfileRequest"
    ) {
      override fun encodedSize(value: CreateStudentProfileRequest): Int = 
      ...
      override fun encode(writer: ProtoWriter, value: CreateStudentProfileRequest) {
      ...
      override fun decode(reader: ProtoReader): CreateStudentProfileRequest {
        ...
        return CreateStudentProfileRequest(
          degrees = degrees,
      ...
      override fun redact(value: CreateStudentProfileRequest): CreateStudentProfileRequest =
          value.copy(
